...
if __name__ == "__main__":
    ...
    subpaths = {
        "train": ["train-clean-100", "ami-sdm1-train", "ami-ihm-train", "ted-train", "commonvoice-train"],
        "dev": ["dev-other", "ami-sdm1-dev", "ami-ihm-dev", "ted-dev", "commonvoice-dev"],
        "test": ["test-other", "ami-sdm1-test", "ami-ihm-test", "ted-test", "commonvoice-test"],
    }
