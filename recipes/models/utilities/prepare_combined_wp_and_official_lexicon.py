...
if __name__ == "__main__":
    ...
    subpaths = {
        "train": ["train-clean-100", "train-clean-360", "train-other-500", "ami-sdm1-train", "ami-ihm-train", "ted-train", "commonvoice-train"],
        "dev": ["dev-clean", "dev-other", "ami-sdm1-dev", "ami-ihm-dev", "ted-dev", "commonvoice-dev"],
        "test": ["test-clean", "test-other", "ami-sdm1-test", "ami-ihm-test", "ted-test", "commonvoice-test"],
    }
    ...
    prefix = "combined-train-all-unigram-{}".format(num_wordpieces)
    ...
    for nbest in args.nbest.split(","):
        ...
        lexicon_name_train = "combined-train-unigram-{sz}-nbest{n}.lexicon".format(
            sz=num_wordpieces, n=nbest
        )
